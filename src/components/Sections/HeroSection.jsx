...
<div className="max-w-400 mx-auto min-h-114.25 bg-linear-to-br from-[#fbfbfb] to-[#d2d2d2] flex flex-col lg:flex-row lg:justify-center ">
    <div className="w-[90%] lg:w-[37%] mx-auto min-h-114.25  flex items-center">
        <div>
         <h2 className=" text-3xl font-normal lg:text-[30px] text-[#ed1c24] mb-4">قرعه‌کشی مصرف‌کنندگان گلستان</h2>
              <h2 className="box-two text-xl lg:text-2xl font-light text-[#58595b] mb-6">قرعه‌کشی دوره‌ای مصرف‌کنندگان چای گلستان</h2>
              <h2 className="box-three animate__animated animate__fadeInDown text-base lg:text-lg font-light text-[#898989] leading-loose my-8 lg:my-10">
                هر یک از مصرف‌کنندگان محصولات چای گلستان می‌توانند با ارسال کد قرعه کشی روی بسته به شماره 30007405 در قرعه کشی‌های دوره‌ای سال 1403شرکت کنند. نگهداری از بسته‌بندی محصول برای اهدای جایزه الزامی است.
              </h2>
